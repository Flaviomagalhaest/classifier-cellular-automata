...
class Classifiers:
   ...
   def getSVM(self, names=[], classifiers=[]):
      ...
      classifiers.append(SVC(kernel="poly", degree=3, C=0.025))
      classifiers.append(SVC(kernel="rbf", C=1, gamma=2))
      classifiers.append(SVC(kernel='sigmoid'))
      classifiers.append(SVC(decision_function_shape='ovo'))
      classifiers.append(NuSVC(kernel="linear"))
      classifiers.append(NuSVC(kernel="poly", degree=3))
      classifiers.append(NuSVC(kernel="rbf",gamma=2))
      classifiers.append(NuSVC(kernel='sigmoid'))
      classifiers.append(NuSVC(decision_function_shape='ovo'))
